    ...
    return (
        <section id="faq" className="flex flex-col justify-center items-center py-12 gap-4 px-10 bg-secondaryDark text-white">
            <article className="flex flex-col justify-center items-center gap-2 text-center">
                ...
                <Link target="_blank" href="https://calendly.com/admin-groundupmvp/project" className="bg-charcoal text-white rounded-full px-8 py-2 flex justify-center items-center border border-primaryLight w-fit">Book a call</Link>
            </article>
